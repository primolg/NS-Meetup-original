        ...
        return ( 
            <div>
                ...
                {data.map(train => {
                    ...
                    return (
                        <div className={(train.arrivalStatus === "INCOMING" ? "single-train incoming" : (train.arrivalStatus === "ON_STATION" ? "single-train on-station": "single-train departed"))} key={train.actualDateTime}>
