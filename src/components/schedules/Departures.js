        ...
        return (
            <div>
                ...
                {data.map(train => {
                    ...
                    return (
                        <div className={(train.departureStatus === "INCOMING" ? "single-train incoming" : (train.departureStatus === "ON_STATION" ? "single-train on-station": "single-train departed"))} key={train.actualDateTime}>
